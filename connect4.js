...
class Game {
  ...
  makeHtmlBoard() {
    ...
    // handle user input
    this.handleUserInput = this.handleClick.bind( this );
    top.addEventListener("click", this.handleUserInput);
  ...
  endGame(msg) {
    ...
    top.removeEventListener( "click", this.handleUserInput );
  }
...
//let  // array of rows, each row is array of cells  (board[y][x])
